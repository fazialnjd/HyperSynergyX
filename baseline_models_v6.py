...
Models (8 total — chosen for high-dim / low-sample regime)
----------------------------------------------------------
...
def make_plots(results, out_dir):
    ...
    ax.set_title(
        "AUROC — Profile 243-dim, No Augmentation (v6)\n"
    ...
    ax.set_title("ROC Curves — Profile 243-dim (v6)", fontsize=12)
    ...
    ax.set_title("PR Curves — Profile 243-dim (v6)", fontsize=12)
...
if __name__ == "__main__":
    ...
    print("  Profile 243-dim | 8 models | No augmentation")
    print("=" * 55)
